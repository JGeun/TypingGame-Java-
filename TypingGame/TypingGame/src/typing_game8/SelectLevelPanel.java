...
public class SelectLevelPanel extends JPanel{
		...
		contentPane.addKeyListener(new KeyAdapter(){
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_ENTER:
						...
						if(arrowPosX < 405)
						   gameBackground = new ImageIcon(Main.class.getResource("../images/springGameBackground.png")).getImage();
						else if(arrowPosX > 900)
							gameBackground = new ImageIcon(Main.class.getResource("../images/winterGameBackground.png")).getImage();
						else
							gameBackground = new ImageIcon(Main.class.getResource("../images/autumnGameBackground.png")).getImage();
						GamePanel gamePanel = new GamePanel(contentPane, new Game(gameBackground));
	...
	public void setBackArrow(Container contentPane) {
		...
		backArrow.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				MainPanel mainPanel = new MainPanel(contentPane);
