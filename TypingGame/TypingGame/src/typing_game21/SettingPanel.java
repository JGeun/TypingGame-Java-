...
public class SettingPanel extends JPanel{
	...
	public void setWordInputField() {
		...
		btn_Add.setContentAreaFilled(false); //버튼 영역 배경 표시 설정
		btn_Add.setFocusPainted(false); //포커스 표시 설정
		add(btn_Add);
	}
	
	//사운드 버튼 설정
	public void setSoundBtn(Container contentPane, int btnPosX, int btnPosY) {
		if(Main.userSetSoundOn){ //사용자가 음악을 켜놨을 때
		...
		soundBtn.setContentAreaFilled(false); //버튼 영역 배경 표시 설정
		soundBtn.setFocusPainted(false); //포커스 표시 설정
