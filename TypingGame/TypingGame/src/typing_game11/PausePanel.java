...
public class PausePanel extends JPanel{
	...
	public PausePanel(Container contentPane, GamePanel gamePanel, WordThread wordThread) {
		setSize(Main.SCREEN_WIDTH, Main.SCREEN_HEIGHT);
		
		setLayout(null);
		PauseMenuPanel menuPanel = new PauseMenuPanel(contentPane, gamePanel, this, wordThread);
		repaint();
